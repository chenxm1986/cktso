...
public:
	...
	//cx[] can be nullptr, if the values are unavailable when analysis
	...
	void ForFactorization(const double cx[])
	{
		const _int_t n = n_ / 2;
		for (_int_t i = 0; i < n; ++i)
		{
	...
	inline _int_t n() const { return n_; }
